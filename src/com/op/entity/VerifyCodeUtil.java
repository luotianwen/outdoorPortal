...
public class VerifyCodeUtil {
     ...
     * 验证码类型为四则算法
     */  
    public static final int TYPE_ARITHMETIC = 7;
    ...
    public static String generateTextCode(int type, int length, String excludeString){  
        ...
        switch(type){  
            ...
            case TYPE_ARITHMETIC:
                ...
                switch (t) {
				case 0:
					verifyCode.append(num1+"+"+num2+"=?,"+(num1+num2));
					break;
				case 1:
					if(num1>num2){
						verifyCode.append(num1+"-"+num2+"=?,"+(num1-num2));
					}else{
						verifyCode.append(num2+"-"+num1+"=?,"+(num2-num1));
					}
					break;
				case 2:
					verifyCode.append(num1+"x"+num2+"=?,"+(num1*num2));
					break;
				default:
					verifyCode.append("1+1=?,2");
					break;
				} 
            break;
        }  

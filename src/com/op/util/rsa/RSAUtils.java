...
* 类描述：    RSA算法加密/解密工具类。
* 创建人：Win Zhong   
* 创建时间：2016年3月4日 下午3:21:02   
* 修改人：Win Zhong   
* 修改时间：2016年3月4日 下午3:21:02   
* 修改备注：   
* @version    1.0
*
 */
public abstract class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
    	String jiami = RSAUtils.encryptString("8888");
    	System.out.println(jiami+"**************"+			RSAUtils.getPublicKeyMap());
        System.out.println(RSAUtils.decryptStringByJs(jiami));
    }
}

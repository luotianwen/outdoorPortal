...
public class PointServiceShowDTO {
	// id
	private int ps_id;
	// 地点中文名
	...
	//场馆项目
	private List<PointServiceProjectDTO> pointServiceProjectDTOList;
	...
	public List<PointServiceProjectDTO> getPointServiceProjectDTOList() {
		return pointServiceProjectDTOList;
	}

	public void setPointServiceProjectDTOList(
			List<PointServiceProjectDTO> pointServiceProjectDTOList) {
		this.pointServiceProjectDTOList = pointServiceProjectDTOList;
	}
